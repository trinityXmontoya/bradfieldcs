...
(defn num-of-inversions-merge-sort
  [coll]
  (let [[[sorted-left left-invs] [sorted-right right-invs]] (map inv-count (-split-coll coll))
        split-invs (merge-and-count sorted-left sorted-right)]
    (+ left-invs right-invs split-invs)))
